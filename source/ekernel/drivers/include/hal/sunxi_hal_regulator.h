...
int hal_regulator_get_voltage(struct regulator_dev *rdev, int *vol_uV);
int hal_regulator_set_voltage(struct regulator_dev *rdev, int target_uV);
...
int axp_byte_write(struct regulator_dev *rdev, u8 reg, u8 reg_val);
int axp_byte_update(struct regulator_dev *rdev, u8 reg, u8 val, u8 mask);
