...
static int sunxi_spi_gpio_init(void)
{
	...
	if (BT0_head.prvt_head.storage_gpio[i].port) {
		for (i = 0; i < 6; i++) {
			sunxi_gpio_set_cfgpin(SUNXI_GPIO_POSITION(
				BT0_head.prvt_head.storage_gpio[i].port,
				BT0_head.prvt_head.storage_gpio[i].port_num),
				BT0_head.prvt_head.storage_gpio[i].mul_sel);

			sunxi_gpio_set_drv(SUNXI_GPIO_POSITION(
				BT0_head.prvt_head.storage_gpio[i].port,
				BT0_head.prvt_head.storage_gpio[i].port_num),
				BT0_head.prvt_head.storage_gpio[i].drv_level);

			if (!BT0_head.prvt_head.storage_gpio[i].pull)
				sunxi_gpio_set_pull(SUNXI_GPIO_POSITION(
				BT0_head.prvt_head.storage_gpio[i].port,
				BT0_head.prvt_head.storage_gpio[i].port_num),
				1);
		}
...
#define SPI_DRV_LEVEL (2)
	...
	sunxi_gpio_set_drv(SUNXI_GPC(0), SPI_DRV_LEVEL); /*spi0_sclk */
	sunxi_gpio_set_drv(SUNXI_GPC(5), SPI_DRV_LEVEL); /*spi0_cs0*/
	sunxi_gpio_set_drv(SUNXI_GPC(2), SPI_DRV_LEVEL); /*spi0_mosi*/
	sunxi_gpio_set_drv(SUNXI_GPC(3), SPI_DRV_LEVEL); /*spi0_miso*/
	...
	sunxi_gpio_set_drv(SUNXI_GPC(0), SPI_DRV_LEVEL); /*spi0_sclk */
	sunxi_gpio_set_drv(SUNXI_GPC(1), SPI_DRV_LEVEL); /*spi0_cs0*/

	sunxi_gpio_set_drv(SUNXI_GPC(2), SPI_DRV_LEVEL); /*spi0_mosi*/
	sunxi_gpio_set_drv(SUNXI_GPC(3), SPI_DRV_LEVEL); /*spi0_miso*/
	sunxi_gpio_set_drv(SUNXI_GPC(10), SPI_DRV_LEVEL); /*spi0_cs1*/
	sunxi_gpio_set_drv(SUNXI_GPC(13), SPI_DRV_LEVEL); /*spi0_wp*/
	sunxi_gpio_set_drv(SUNXI_GPC(14), SPI_DRV_LEVEL); /*spi0_hold*/
	...
	sunxi_gpio_set_drv(SUNXI_GPC(0),  SPI_DRV_LEVEL); /*spi0_sclk */
	sunxi_gpio_set_drv(SUNXI_GPC(3),  SPI_DRV_LEVEL); /*spi0_cs0*/

	sunxi_gpio_set_drv(SUNXI_GPC(2),  SPI_DRV_LEVEL); /*spi0_mosi*/
	sunxi_gpio_set_drv(SUNXI_GPC(4),  SPI_DRV_LEVEL); /*spi0_miso*/
	sunxi_gpio_set_drv(SUNXI_GPC(7),  SPI_DRV_LEVEL); /*spi0_cs1*/
	sunxi_gpio_set_drv(SUNXI_GPC(15), SPI_DRV_LEVEL); /*spi0_wp*/
	sunxi_gpio_set_drv(SUNXI_GPC(16), SPI_DRV_LEVEL); /*spi0_hold*/
	...
	sunxi_gpio_set_drv(SUNXI_GPC(2), SPI_DRV_LEVEL); /*spi0_mosi*/
	sunxi_gpio_set_drv(SUNXI_GPC(3), SPI_DRV_LEVEL); /*spi0_miso*/
	sunxi_gpio_set_drv(SUNXI_GPC(4), SPI_DRV_LEVEL); /*spi0_wp*/
	sunxi_gpio_set_drv(SUNXI_GPC(5), SPI_DRV_LEVEL); /*spi0_hold*/
